...
(function () {
    ...
    .controller('EventCtrl', ['$scope', 'MainTitle', function ($scope, mainTitle) {
        ...
        },
        {
            title: "Seattle",
            itemTitle: mainTitle.title,
            description: " is a two day event that teaches kids how to code",
            imgName: "seattle",
        ...
        },
        {
            title: "San Francisco",
            itemTitle: mainTitle.title,
            description: " is a three day event that teaches kids how to code",
            imgName: "sanfran",
        ...
        },
        {
            title: "Vancouver",
            itemTitle: mainTitle.title,
            description: " is a four day event that teaches kids how to code",
            imgName: "vancouver",
        ...
        },
        {
            title: "Brighton",
            itemTitle: mainTitle.title,
            description: " is a five day event that teaches kids how to code",
            imgName: "brighton",
...

        {
            title: "London",
            itemTitle: mainTitle.title,
            description: " is a six day event that teaches kids how to code",
            imgName: "London",
